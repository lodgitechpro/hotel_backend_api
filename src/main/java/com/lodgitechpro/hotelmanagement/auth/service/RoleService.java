...
import com.lodgitechpro.hotelmanagement.auth.repository.PermissionRepository;
import com.lodgitechpro.hotelmanagement.auth.repository.RolePermissionRepository;
...
public class RoleService {
    ...
    public void saveRolePermissions(int roleId, List<Integer> permissionIds) {
