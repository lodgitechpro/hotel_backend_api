...
import com.lodgitechpro.hotelmanagement.repository.RoleFormRepository;
...
public class MenuFormService {
    ...
    public void saveRoleForm(long roleId, List<Long> formIds) {
    ...
    public void copyRoleForms(long fromRoleId, long toRoleId) {
    ...
    public List<FormDto> getRoleForms(long roleId) {
        Role role = roleRepository.findById(roleId)
                .orElseThrow(() -> new EntityNotFoundException("Role not found with id "+ roleId));
    ...
    public List<FormDto> getMenuForms(long menuId) {
