...
import com.lodgitechpro.hotelmanagement.dtos.EmployeeDto;
import com.lodgitechpro.hotelmanagement.service.EmployeeService;
...
public class EmployeeController {
    ...
    public ResponseEntity<?> copyEmployeeRoles(
            @RequestParam("fromEmpId") long fromEmpId,
            @RequestParam("toEmpId") long toEmpId) {
